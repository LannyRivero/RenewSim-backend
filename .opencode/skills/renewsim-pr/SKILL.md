...
name: renewsim-pr
description: >
  Creates Pull Requests for RenewSim following the project template and conventions.
...
- [ ] This feature/issue is listed in [here](https://github.com/renewsim-cloud/renewsim/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen) or roadmap.renewsim.com
- [ ] Is it assigned to me, if not, request it via the issue/feature in [here](https://github.com/renewsim-cloud/renewsim/issues?q=sort%3Aupdated-desc+is%3Aissue+is%3Aopen) or [RenewSim Community Slack](goto.renewsim.com/slack)
...
| --------- | ------------------------- | ---------------------------------------------------------------------- |
| SDK       | `renewsim/CHANGELOG.md`    | New checks → permissions update?                                       |
