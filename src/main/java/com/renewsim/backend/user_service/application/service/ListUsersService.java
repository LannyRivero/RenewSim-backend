...
public class ListUsersService implements ListUsersUseCase {
    ...
    @Override
    public PageResponse<UserResponse> list(int page, int size, String username, String email, Boolean enabled) {
        var p = adapter.search(username, email, enabled, page, size);
