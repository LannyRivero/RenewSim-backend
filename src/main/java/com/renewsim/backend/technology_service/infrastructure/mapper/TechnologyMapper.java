...
/**
 * MapStruct mapper to convert between domain models and persistence entities.
 * Custom conversion logic added for Value Objects (VOs).
 */
@Mapper(
    componentModel = "spring",
    implementationName = "TechnologyMapperImpl",
    unmappedTargetPolicy = ReportingPolicy.IGNORE,
    imports = { BigDecimal.class, Efficiency.class, InstallationCost.class, MaintenanceCost.class,
                EnvironmentalImpact.class, Co2Reduction.class, EnergyProduction.class, EnergyType.class }
)
public interface TechnologyMapper {
    ...
    @Mapping(target = "co2Reduction", expression = "java(domain.getCo2Reduction().value().doubleValue())") // ✅ FIX
