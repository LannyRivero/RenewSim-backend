...
public final class ScenarioSnapshotMetricsResolver {
        ...
        public ScenarioSnapshotMetrics resolve(SimulationReadModel simulation, DashboardSnapshotData details) {
                ...
                Double capex = simulation.capexTotal();
                ...
                double co2SavedKg = annualGeneration > 0.0 && simulation.technology() != null
                                ? technologyLookupPort.findActiveCo2ReductionFactorByEnergyType(simulation.technology())
