...
public class SolarSimulationEngine implements SimulationEngine {
    ...
    private SimulationDetailsResult buildResult(
        ...
        SimulationAssessmentPolicy.Assessment summaryResult = assessmentPolicy.assess(command, solarProfile, specificYield, financialResult);
        ...
        return new SimulationDetailsResult(
                ...
                new SimulationDetailsResult.Technical(
                        ...
                        new SimulationDetailsResult.LossesSummary(round(solarProfile.losses().inverter(), 2), round(solarProfile.losses().temperature(), 2), round(solarProfile.losses().wiring(), 2), round(solarProfile.losses().soiling(), 2), round(solarProfile.losses().other(), 2), round(totalLossPct, 2)),
                        balances),
