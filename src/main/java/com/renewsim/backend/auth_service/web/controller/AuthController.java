...
public class AuthController {
        ...
        public ResponseEntity<OperationResponse<RegisterResponseDTO>> register(
                ...
                return ResponseEntity.status(201)
                                .body(ApiResponseFactory.created(response,
        ...
        @Operation(summary = "Login user", description = "Authenticates user with email and password. Returns JWT access token and sets refresh token in HttpOnly cookie.")
        @ApiResponses(value = {
        ...
        public ResponseEntity<OperationResponse<LoginResponseDTO>> login(
                ...
                // Return access token in response body (refresh token excluded)
                ...
                return ResponseEntity.ok(ApiResponseFactory.ok(loginResponse, "Login successful"));
        }
