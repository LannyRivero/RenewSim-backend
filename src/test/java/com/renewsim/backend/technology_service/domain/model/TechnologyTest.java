...
class TechnologyTest {
    ...
    void shouldCreateValidTechnology() {
        Technology tech = TechnologyFactory.create(
                "Solar Panel", 85.0, 1200, 100, 15, 250, 6000, "SOLAR"
        );
    ...
    void shouldThrowWhenEfficiencyInvalid() {
        assertThrows(InvalidTechnologyParameterException.class, () ->
                TechnologyFactory.create("Invalid", 150.0, 1000, 100, 10, 200, 5000, "SOLAR"));
    }

    @Test
    void shouldCompareByNameIgnoringCase() {
        Technology t1 = TechnologyFactory.create("Solar", 80.0, 1000, 100, 10, 100, 5000, "SOLAR");
        Technology t2 = TechnologyFactory.create("solar", 90.0, 1200, 150, 12, 110, 5200, "SOLAR");
